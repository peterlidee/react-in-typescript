...
// or export const UnknownContext = createContext<null | ThemeUnknownContextType>(null);
...
export const ThemeUnknownContextProvider = ({ children }: Props) => {
  ...
  return <ThemeUnknownContext.Provider value={{ theme, toggleTheme }}>{children}</ThemeUnknownContext.Provider>
}